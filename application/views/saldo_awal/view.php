...
<form name="form" method="post" action="<?php echo base_url();?>saldo_awal">
Periode : 
...
<a href="<?php echo base_url();?>saldo_awal/tambah">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <a href="<?php echo base_url();?>saldo_awal/edit/<?php echo $db['periode'];?>/<?php echo $db['no_rek'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>saldo_awal/hapus/<?php echo $db['periode'];?>/<?php echo $db['no_rek'];?>"
