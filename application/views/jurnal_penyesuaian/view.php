...
$(document).ready(function(){
	...
	$("#kembali").click(function(){
		window.location.assign('<?php echo base_url();?>jurnal_penyesuaian');
	});
});
...
<a href="<?php echo base_url();?>jurnal_penyesuaian">
<button type="button" name="refresh" id="refresh" class="easyui-linkbutton" data-options="iconCls:'icon-reload'">Refresh</button>
</a>
</div>
<div style="float:right; padding-bottom:5px;">
<form name="form" method="post" action="<?php echo base_url();?>jurnal_penyesuaian">
...
<tr>
    ...
    <fieldset style="padding:8px;">
    	<center><h1>JURNAL PENYESUAIAN</h1></center>
    </fieldset>
	</td>
    <td width="50%" valign="top">
    	<fieldset>
