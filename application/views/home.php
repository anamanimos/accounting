...
<div class="header" style="height:70px;background:white;padding:2px;margin:0;">
        ...
        <img src='<?php echo base_url();?>asset/images/Banner.svg' style="padding:5px; margin:0;" height="60">
        </div>
	...
	<div class="panel-header" fit="true" style="height:21px;padding-top:1px;padding-right:20px">
		<div style="float:left;">
			<a href="<?php echo base_url();?>home" class="easyui-linkbutton" data-options="plain:true" iconCls="icon-home">Home</a>
            <a href="<?php echo base_url();?>login/logout" class="easyui-linkbutton" data-options="plain:true" iconCls="icon-logout">Logout</a>
		</div>
