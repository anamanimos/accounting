...
$(document).ready(function(){
  ...
  $("#kembali").click(function(){
    window.location.assign('<?php echo base_url();?>users');
    return false();
  });
});
...
<div id="view">
    ...
    <form name="form" method="post" action="<?php echo base_url();?>users">
  ...
  if($data->num_rows()>0){
    ...
    ?>
      ...
      <img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
            ...
            <a href="<?php echo base_url();?>users/hapus/<?php echo $db['username'];?>"
