...
$(document).ready(function(){
	...
	$("#kembali").click(function(){
		window.location.assign('<?php echo base_url();?>rekening');
		return false();
	});
});
...
<div id="view">
    ...
    <form name="form" method="post" action="<?php echo base_url();?>rekening">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <a href="<?php echo base_url();?>rekening/hapus/<?php echo $db['no_rek'];?>"
