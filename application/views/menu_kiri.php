...
<div id="kiri" style="float:left;">
    ...
    <div id="menu1" title="Menu" data-options="iconCls:'icon-tip'"  style="overflow:auto;padding:5px 0px;">
        ...
        <ul class="easyui-tree" >
            ...
            <li data-options="iconCls:'icon-surat_keluar'">
                <a href="<?php echo base_url();?>jurnal_umum">Jurnal Umum</a>
            </li>
            <li data-options="iconCls:'icon-surat_keluar'">
                <a href="<?php echo base_url();?>buku_besar">Buku Besar</a>
            </li>
            <li data-options="iconCls:'icon-surat_keluar'">
    ...
    <div id="menu2" title="Laporan" data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
        ...
        <ul class="easyui-tree">
            <li>
                <span><a href="<?php echo base_url();?>lap_buku_besar">Buku Besar</a></span>
            </li>
            <li>
                <span><a href="<?php echo base_url();?>lap_neraca_saldo">Neraca Saldo</a></span>
            </li>
            <li>
                <span><a href="<?php echo base_url();?>lap_neraca_lajur">Neraca Lajur</a></span>
            </li>
            <li>
                <span><a href="<?php echo base_url();?>lap_laba_rugi">Laba Rugi</a></span>
            </li>
            <li>
                <span><a href="<?php echo base_url();?>lap_neraca">Neraca</a></span>
            </li>
        </ul>
    </div>
    </div>
    <div id="menu3" title="Grafik" data-options="iconCls:'icon-grafik'" style="overflow:auto;padding:5px 0px;">
        ...
        <ul class="easyui-tree">
            <li>
                <span><a href="<?php echo base_url();?>grafik">Jurnal</a></span>
            </li>
        </ul>
    </div>
    </div>
